...
def get_layout():
    ...
    box = HBox(align=Align.CENTER, widgets=[button1], background=Color.BLUE)
    frame = Frame(size=Size(800, 600), pos=Position(0, 0), widget=box, margin=Margin(50, 50, 50, 50), background=Color.RED)
    return frame
