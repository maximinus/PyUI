...
class TestVBox(PyuiTest):
    # essentially the same tests as HBox, but for vertical layout
    def test_single_box_no_margins(self):
    ...
    def test_single_box_with_margins(self):
        box = VBox(spacing=0, margin=Margin(10, 10, 10, 10))
        box.add_child(ColorRect(color=(255, 0, 0), size=Size(50, 50)))
        image = Surface((100, 100))
        image.fill((0, 0, 0))
        box.render(image, Position(0, 0), Size(100, 100))
        ...
        self.assertPixel(image, Position(0, 0), (0, 0, 0))
        self.assertPixel(image, Position(10, 10), (255, 0, 0))
        self.assertPixel(image, Position(10, 60), (0, 0, 0))

    def test_single_box_with_left_margin(self):
        box = VBox(spacing=0, margin=Margin(15, 0, 0, 0))
        box.add_child(ColorRect(color=(255, 0, 0), size=Size(50, 50)))
        image = Surface((100, 100))
        image.fill((0, 0, 0))
        box.render(image, Position(0, 0), Size(100, 100))
        ...
        self.assertPixel(image, Position(0, 0), (0, 0, 0))
        self.assertPixel(image, Position(15, 0), (255, 0, 0))
        self.assertPixel(image, Position(15, 50), (0, 0, 0))

    def test_single_box_with_top_margin(self):
        box = VBox(spacing=0, margin=Margin(0, 0, 20, 0))
        box.add_child(ColorRect(color=(255, 0, 0), size=Size(50, 50)))
        image = Surface((100, 100))
        image.fill((0, 0, 0))
        box.render(image, Position(0, 0), Size(100, 100))
        ...
        self.assertPixel(image, Position(0, 0), (0, 0, 0))
        self.assertPixel(image, Position(0, 20), (255, 0, 0))
        self.assertPixel(image, Position(0, 70), (0, 0, 0))
    ...
    def test_two_boxes_no_spacing(self):
        box = VBox(spacing=0, margin=Margin(0, 0, 0, 0))
        box.add_child(ColorRect(color=(255, 0, 0), size=Size(50, 30)))
        ...
        self.assertPixel(image, Position(0, 60), (0, 0, 0))

    def test_two_boxes_with_spacing(self):
        box = VBox(spacing=10, margin=Margin(0, 0, 0, 0))
        box.add_child(ColorRect(color=(255, 0, 0), size=Size(50, 30)))
        box.add_child(ColorRect(color=(0, 255, 0), size=Size(50, 30)))
        image = Surface((100, 100))
        image.fill((0, 0, 0))
        ...
        self.assertPixel(image, Position(0, 40), (0, 255, 0))
        self.assertPixel(image, Position(0, 70), (0, 0, 0))

    def test_three_boxes_with_spacing_and_margin(self):
        box = VBox(spacing=5, margin=Margin(5, 5, 5, 5))
        box.add_child(ColorRect(color=(255, 0, 0), size=Size(40, 20)))
        box.add_child(ColorRect(color=(0, 255, 0), size=Size(40, 20)))
        ...
        self.assertPixel(image, Position(5, 30), (0, 255, 0))
        self.assertPixel(image, Position(5, 50), (0, 0, 0))  # Spacing
        self.assertPixel(image, Position(5, 55), (0, 0, 255))
        self.assertPixel(image, Position(5, 75), (0, 0, 0))

    def test_expanding_child(self):
        box = VBox(spacing=0, margin=Margin(0, 0, 0, 0))
        box.add_child(ColorRect(color=(255, 0, 0), size=Size(50, 30), expand=Expand.VERTICAL))
        box.add_child(ColorRect(color=(0, 255, 0), size=Size(50, 30)))
        image = Surface((100, 100))
        image.fill((0, 0, 0))
        box.render(image, Position(0, 0), Size(100, 100))
    ...
    def test_multiple_expanding_children(self):
        box = VBox(spacing=0, margin=Margin(0, 0, 0, 0))
        box.add_child(ColorRect(color=(255, 0, 0), size=Size(50, 20), expand=Expand.VERTICAL))
        ...
        self.assertPixel(image, Position(0, 50), (0, 255, 0))
        self.assertPixel(image, Position(0, 99), (0, 255, 0))
    ...
    def test_uneven_expanding_children(self):
        ...
        self.assertPixel(image, Position(0, 40), (0, 255, 0))
        self.assertPixel(image, Position(0, 79), (0, 255, 0))
        self.assertPixel(image, Position(0, 80), (0, 0, 255))

    def test_horizontal_expanding_has_no_effect(self):
        box = VBox(spacing=0, margin=Margin(0, 0, 0, 0))
        box.add_child(ColorRect(color=(255, 0, 0), size=Size(30, 30), expand=Expand.HORIZONTAL))
        box.add_child(ColorRect(color=(0, 255, 0), size=Size(30, 30)))
        image = Surface((100, 100))
        image.fill((0, 0, 0))
        box.render(image, Position(0, 0), Size(100, 100))
    ...
    def test_different_width_children(self):
        box = VBox(spacing=0, margin=Margin(0, 0, 0, 0))
        box.add_child(ColorRect(color=(255, 0, 0), size=Size(20, 30)))
        ...
        self.assertPixel(image, Position(20, 0), (0, 0, 0))
        self.assertPixel(image, Position(0, 30), (0, 255, 0))
        self.assertPixel(image, Position(39, 30), (0, 255, 0))
        self.assertPixel(image, Position(40, 30), (0, 0, 0))
    ...
    def test_spacing_without_margin(self):
        ...
        self.assertPixel(image, Position(0, 30), (0, 255, 0))
        self.assertPixel(image, Position(0, 50), (0, 0, 0))  # Spacing
        self.assertPixel(image, Position(0, 60), (0, 0, 255))

    def test_min_size_calculation(self):
        box = VBox(spacing=5, margin=Margin(10, 10, 10, 10))
        box.add_child(ColorRect(color=(255, 0, 0), size=Size(30, 20)))
        box.add_child(ColorRect(color=(0, 255, 0), size=Size(20, 20)))
        # Min size should be children sizes + spacing + margins
        # 30 + (10 + 10) width, (20 + 20) + 5 + (10 + 10) height
        self.assertEqual(box.min_size, Size(50, 65))
    ...
    def test_not_enough_space(self):
        box = VBox(spacing=0, margin=Margin(0, 0, 0, 0))
        box.add_child(ColorRect(color=(255, 0, 0), size=Size(50, 60)))
        ...
        self.assertPixel(image, Position(0, 60), (0, 255, 0))
