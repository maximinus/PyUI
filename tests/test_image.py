...
class TestImageRendering(PyuiTest):
    def test_basic_render(self):
        ...
        image_widget.render(mouse, dest_surface, Position(0, 0), Size(100, 100))
    ...
    def test_render_with_margin(self):
        ...
        mouse = self.create_mouse()
        image_widget.render(mouse, dest_surface, Position(0, 0), Size(50, 50))
        self.assertPixel(dest_surface, Position(0, 0), Color(0, 0, 0))
    ...
    def test_render_with_alignment_top_left(self):
        ...
        dest_surface = pygame.Surface((100, 100))
        dest_surface.fill(Color(0, 0, 0))
        image_widget.render(self.mouse, dest_surface, Position(0, 0), Size(100, 100))
    ...
    def test_render_with_position_offset(self):
        ...
        image_widget.render(self.mouse, dest_surface, Position(10, 10), Size(80, 80))
