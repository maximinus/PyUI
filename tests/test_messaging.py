...
class TestMessage(unittest.TestCase):
    def test_message_initialization(self):
        ...
        msg_type = MessageType.ADD_WIDGET_LAYER
        sender = "test_sender"
        data = {"key": "value"}
...
class TestMessageBus(unittest.TestCase):
    ...
    def test_unsubscribe_all(self):
        ...
        subscriber = Mock()
        msg_type1 = MessageType.ADD_WIDGET_LAYER
        msg_type2 = MessageType.ADD_WIDGET_LAYER  # Using same type since we only have one defined
